...
class ForkliftBehaviourBase(BehaviorScript):
    ...
    def _init_config(self) -> None:
        ...
        # Pick parameters
        self.pick_prepick_dist: float      = 4.0   # distance from pallet center to pre-pick point (m)
        self.pick_insert_offset: float     = 1.8   # fallback: stop when body this close to pallet (m)
        self.pick_insert_drive_dist: float = 2.5   # primary: stop after driving this far from prepick (m)
        ...
        self.pick_lift_approach_offset: float = -0.45  # forks offset from pallet Z (negative = below)
